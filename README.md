...
- відкрити DevTools, знайти вкладку "источники", потім нажати "добавление папки" (./img/tools-01.png)
- вибираємо проект який ми хочемо відслідковувати і жмемо кнопку "Разрешить" (./img/tools-02.png)
- ваш проект з'являється в списку, і ви зним можете вже працювати (./img/tools-03.png)

## Якщо вам потрібно видалити проект із робочої області:
- клікаємо правою кнопкою миші по потрібному вам проєкту і вибираємо "Удалить из рабочей области" (./img/tools-04.png)
