...
```
Якщо вам потрібно зробити діапазон в якому повинні працювати стилі, то використовуєте вкладені медіазапроси
![вкладені медіазапроси](./img/tools-05.png)
![вкладені медіазапроси](./img/tools-06.png)

# Як зробити так, щоб стилі які ви змінюєте в інспекторі коду в браузері (Chrome), зберігалися в файлах проекту.
- відкрити DevTools, знайти вкладку "источники", потім нажати "добавление папки" ![добавление папки](./img/tools-01.png)
- вибираємо проект який ми хочемо відслідковувати і жмемо кнопку "Разрешить" ![Разрешить](./img/tools-02.png)
- ваш проект з'являється в списку, і ви зним можете вже працювати ![ваш проект з'являється в списку](./img/tools-03.png)

## Якщо вам потрібно видалити проект із робочої області:
- клікаємо правою кнопкою миші по потрібному вам проєкту і вибираємо "Удалить из рабочей области" ![Удалить из рабочей области](./img/tools-04.png)